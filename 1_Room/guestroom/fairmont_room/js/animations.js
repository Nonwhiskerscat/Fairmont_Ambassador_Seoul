$(document).ready(function() {
    ...
    $('h3.gall, h3.type, .room_gnb, .three_types, h3.notc, h3.orooms').css({
        'opacity': '0',
        'top': '-50px',
        'position': 'relative'
    ...
    $('.room_cont, .room_entire, .gall_main, .hotel_use, .hotel_book, .other_fair, .other_suit, .other_pent').css({
        'opacity': '0',
    });
    ...
    $(window).scroll(function() {
        ...
        if($(this).scrollTop()>h3_ntop-$(this).innerHeight()/10) {
        ...
        if($(this).scrollTop()>h3_ntop-$(this).innerHeight()+$(this).innerHeight()/10) {
